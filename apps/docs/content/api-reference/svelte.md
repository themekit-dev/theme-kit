...
**Returns** `{ family: { value: void; subscribe: void }; mode: { value: void; subscribe: void }; setFamily: __type(nextFamily: string): void; setMode: __type(nextMode: ThemeMode): void; theme: { value: void; subscribe: void }; toggleTheme: __type(): void }`
...
**Returns** `{ value: void; subscribe: void }`
...
**Returns** `{ canRedo: { value: void; subscribe: void }; canUndo: { value: void; subscribe: void }; clear: __type(): void; history: { value: void; subscribe: void }; jump: __type(index: number): void; redo: __type(): void; undo: __type(): void }`
