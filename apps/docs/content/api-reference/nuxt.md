...
| Parameter | Type | Description |
| --------- | ---- | ----------- |
| `options` | `ThemeBroadcastOptions` (optional) | — |
...
| Parameter | Type | Description |
| --------- | ---- | ----------- |
| `options` | `ThemePersistenceOptions` (optional) | — |
...
| `themeName` | `Name` | — |
| `resolveTokenRefs` | `boolean` (optional) | — |
...
| --------- | ---- | ----------- |
| `theme` | `ThemeDefinition` | — |
| `options` | `ThemeToCSSVariablesOptions` (optional) | — |
...
| Parameter | Type | Description |
| --------- | ---- | ----------- |
| `options` | `UseAdapterOptions` (optional) | — |
...
| --------- | ---- | ----------- |
| `theme` | `ThemeDefinition` | — |
| `options` | `ValidateThemeOptions` (optional) | — |
...
| --------- | ---- | ----------- |
| `theme` | `ThemeDefinition` | — |
| `options` | `ValidateThemeContrastOptions` (optional) | — |
...
| `scheduled` (optional) | `false | ThemeScheduleOptions<ThemeDefinition<string>>` | Sunrise/sunset scheduling. Pass `{ lightTheme, darkTheme, latitude,
...
| `scrollbar` (optional) | `boolean | PrePaintScrollbarOptions` | Custom scrollbar bootstrap. `true` (or options) emits the pre-paint CSS
...
| `transition` (optional) | `boolean | ThemeTransitionOptions` | Theme transitions. `false` disables them; `true` (or an options object)
